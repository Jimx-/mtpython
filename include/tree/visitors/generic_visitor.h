...
public:
    ...
    virtual ASTNode* visit_alias(AliasNode* node) { return node; }
    ...
    virtual ASTNode* visit_break(BreakNode* node) { return node; }
    ...
    virtual ASTNode* visit_continue(ContinueNode* node) { return node; }
    ...
    virtual ASTNode* visit_global(GlobalNode* node) { return node; }
    ...
    virtual ASTNode* visit_name(NameNode* node) { return node; }

    virtual ASTNode* visit_number(NumberNode* node) { return node; }

    virtual ASTNode* visit_string(StringNode* node) { return node; }

    virtual ASTNode* visit_pass(PassNode* node) { return node; }
