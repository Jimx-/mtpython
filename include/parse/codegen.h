...
protected:
    ...
    void make_call(int n, const std::vector<mtpython::tree::ASTNode*>& args,
                   const std::vector<mtpython::tree::KeywordNode*>& keywords);
    void make_closure(mtpython::interpreter::PyCode* code, int args,
                      mtpython::objects::M_BaseObject* qualname);

    virtual int get_code_flags() { return CO_NEWLOCALS; }

public:
    BaseCodeGenerator(const std::string& name, vm::ThreadContext* context,
                      mtpython::tree::ASTNode* module, SymtableVisitor* symtab,
                      int lineno, CompileInfo* info);

    void push_frame_block(FrameType type, CodeBlock* block)
    {
        frame_block.push_back(std::make_pair(type, block));
    }
    ...
    visit_attribute(mtpython::tree::AttributeNode* node);
    // mtpython::tree::ASTNode* visit_arguments(mtpython::tree::ArgumentsNode*
    // node);
    ...
    mtpython::tree::ASTNode*
    visit_importfrom(mtpython::tree::ImportFromNode* node);
    ...
    mtpython::tree::ASTNode*
    visit_subscript(mtpython::tree::SubscriptNode* node);
    ...
    void handle_withitem(mtpython::tree::WithNode* withnode,
                         mtpython::tree::WithItemNode* node);
...
public:
    ModuleCodeGenerator(mtpython::vm::ThreadContext* context,
                        mtpython::tree::ASTNode* module,
                        SymtableVisitor* symtab, CompileInfo* info);
};
...
public:
    AbstractFunctionCodeGenerator(const std::string& name,
...
public:
    FunctionCodeGenerator(const std::string& name,
                          mtpython::vm::ThreadContext* context,
                          mtpython::tree::ASTNode* tree,
                          SymtableVisitor* symtab, int lineno,
                          CompileInfo* info);
...
public:
    LambdaCodeGenerator(const std::string& name,
                        mtpython::vm::ThreadContext* context,
                        mtpython::tree::ASTNode* tree, SymtableVisitor* symtab,
                        int lineno, CompileInfo* info);
};
...
public:
    ClassCodeGenerator(const std::string& name,
                       mtpython::vm::ThreadContext* context,
                       mtpython::tree::ASTNode* tree, SymtableVisitor* symtab,
                       int lineno, CompileInfo* info);
};
