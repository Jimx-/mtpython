...
protected:
    ...
    void binary_truediv(int arg, int next_pc);
    void binary_floordiv(int arg, int next_pc);
    void binary_mod(int arg, int next_pc);
    void binary_lshift(int arg, int next_pc);
    void binary_rshift(int arg, int next_pc);
    void binary_and_(int arg, int next_pc);
    void binary_or_(int arg, int next_pc);
    void binary_xor_(int arg, int next_pc);
    void binary_pow(int arg, int next_pc);
    ...
    void binary_inplace_truediv(int arg, int next_pc);
    void binary_inplace_floordiv(int arg, int next_pc);
    void binary_inplace_mod(int arg, int next_pc);
    void binary_inplace_lshift(int arg, int next_pc);
    void binary_inplace_rshift(int arg, int next_pc);
    void binary_inplace_and(int arg, int next_pc);
    void binary_inplace_or(int arg, int next_pc);
    void binary_inplace_xor(int arg, int next_pc);
    void binary_inplace_pow(int arg, int next_pc);
    ...
    int jump_if_true_or_pop(int arg, int next_pc);
