...
public:
    ...
    virtual void set_class(ObjSpace* space, M_BaseObject* type)
    {
        throw NotImplementedException("set_class()");
    }
    virtual interpreter::Typedef* get_typedef()
    {
        throw NotImplementedException("get_typedef()");
    }
    ...
    virtual M_BaseObject* get_dict_value(ObjSpace* space,
                                         const std::string& attr);
    virtual bool set_dict_value(ObjSpace* space, const std::string& attr,
                                M_BaseObject* value);
