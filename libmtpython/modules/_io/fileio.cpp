...
M_BaseObject* M_FileIO::__new__(mtpython::vm::ThreadContext* context,
...
M_BaseObject* M_FileIO::__init__(mtpython::vm::ThreadContext* context,
                                 const Arguments& args)
{
    ...
    args.parse("__init__", nullptr, init_signature, scope,
               {space->wrap_str(context, "r"), space->new_bool(true)});
    ...
    try {
        ...
        if (fd < 0) {
            throw InterpError(
                ...
                space->wrap_str(context, "negative file descriptor"));
        }
...
M_BaseObject* M_FileIO::name_get(mtpython::vm::ThreadContext* context,
                                 M_BaseObject* self)
{
    M_FileIO* as_fio = static_cast<M_FileIO*>(self);
    return as_fio->name;
...
void M_FileIO::name_set(mtpython::vm::ThreadContext* context, M_BaseObject* obj,
                        M_BaseObject* value)
{
