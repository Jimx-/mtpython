...
M_BaseObject* M_TextIOWrapper::__new__(mtpython::vm::ThreadContext* context,
...
M_BaseObject* M_TextIOWrapper::__init__(mtpython::vm::ThreadContext* context,
                                        const Arguments& args)
{
    static Signature init_signature({"self", "buffer", "encoding", "errors",
                                     "newline", "line_buffering",
                                     "write_through"});
    ObjSpace* space = context->get_space();

    std::vector<M_BaseObject*> scope;
    args.parse("__init__", nullptr, init_signature, scope,
...
M_BaseObject* M_TextIOWrapper::__repr__(mtpython::vm::ThreadContext* context,
                                        M_BaseObject* self)
{
    std::string str;
    ObjSpace* space = context->get_space();
...
M_BaseObject* M_TextIOWrapper::name_get(mtpython::vm::ThreadContext* context,
                                        M_BaseObject* self)
{
    M_TextIOWrapper* as_tio = static_cast<M_TextIOWrapper*>(self);
...
M_BaseObject* M_TextIOWrapper::buffer_get(mtpython::vm::ThreadContext* context,
                                          M_BaseObject* self)
{
    M_TextIOWrapper* as_tio = static_cast<M_TextIOWrapper*>(self);
