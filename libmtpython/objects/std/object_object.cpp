...
Typedef* M_StdObjectObject::get_typedef() { return _object_typedef(); }

Typedef* M_StdObjectObject::_object_typedef()
{
    static Typedef object_typedef(
        "object",
        {
            {"__new__",
             new InterpFunctionWrapper("__new__", M_StdObjectObject::__new__)},
            {"__init__", new InterpFunctionWrapper(
                             "__init__", M_StdObjectObject::__init__)},
            {"__str__",
             new InterpFunctionWrapper("__str__", M_StdObjectObject::__str__)},
            {"__repr__", new InterpFunctionWrapper(
                             "__repr__", M_StdObjectObject::__repr__)},
            {"__getattribute__",
             new InterpFunctionWrapper("__getattribute__",
                                       M_StdObjectObject::__getattribute__)},
            {"__setattr__", new InterpFunctionWrapper(
                                "__setattr__", M_StdObjectObject::__setattr__)},
            {"__delattr__", new InterpFunctionWrapper(
                                "__delattr__", M_StdObjectObject::__setattr__)},
            {"__subclasshook__",
             new InterpFunctionWrapper("__subclasshook__",
                                       M_StdObjectObject::__subclasshook__)},
            {"__dict__", new GetSetDescriptor(M_StdObjectObject::__dict__get,
                                              M_StdObjectObject::__dict__set)},
            {"__class__",
             new GetSetDescriptor(M_StdObjectObject::__class__get)},
        });
    return &object_typedef;
}

M_BaseObject* M_StdObjectObject::__new__(mtpython::vm::ThreadContext* context,
                                         const Arguments& args)
{
    ...
    if (!type_obj)
        throw InterpError::format(
            ...
            "object.__new__(X): X is not a type object (%s)",
            space->get_type_name(wrapped_type).c_str());
...
M_BaseObject* M_StdObjectObject::__init__(mtpython::vm::ThreadContext* context,
                                          const Arguments& args)
{
    ObjSpace* space = context->get_space();
...
M_BaseObject* M_StdObjectObject::__str__(mtpython::vm::ThreadContext* context,
                                         M_BaseObject* obj)
{
    ObjSpace* space = context->get_space();
    ...
    if (!impl) {
        throw InterpError(
            ...
            space->wrap_str(context, "operand does not support unary str"));
    }
    return space->get_and_call_function(context, impl, {obj});
}

M_BaseObject* M_StdObjectObject::__repr__(mtpython::vm::ThreadContext* context,
                                          M_BaseObject* obj)
{
    ObjSpace* space = context->get_space();
...
M_BaseObject*
M_StdObjectObject::__getattribute__(mtpython::vm::ThreadContext* context,
...
M_BaseObject*
M_StdObjectObject::__setattr__(mtpython::vm::ThreadContext* context,
                               M_BaseObject* obj, M_BaseObject* attr,
                               M_BaseObject* value)
{
    ObjSpace* space = context->get_space();
...
M_BaseObject*
M_StdObjectObject::__delattr__(mtpython::vm::ThreadContext* context,
                               M_BaseObject* obj, M_BaseObject* attr)
{
    ObjSpace* space = context->get_space();
    const std::string& name = space->unwrap_str(attr);
...
M_BaseObject*
M_StdObjectObject::__dict__get(mtpython::vm::ThreadContext* context,
                               M_BaseObject* obj)
{
    return obj->get_dict(context->get_space());
}

void M_StdObjectObject::__dict__set(mtpython::vm::ThreadContext* context,
...
M_BaseObject*
M_StdObjectObject::__class__get(mtpython::vm::ThreadContext* context,
                                M_BaseObject* obj)
{
...
M_BaseObject*
M_StdObjectObject::__subclasshook__(mtpython::vm::ThreadContext* context,
                                    const Arguments& args)
{
