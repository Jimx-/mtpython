...
M_BaseObject* M_StdBoolObject::__repr__(mtpython::vm::ThreadContext* context,
                                        mtpython::objects::M_BaseObject* self)
{
    M_StdBoolObject* as_bool = M_STDBOOLOBJECT(self);
    assert(as_bool);

    return context->get_space()->wrap_str(
        context, (as_bool->intval == 1) ? "True" : "False");
}

M_BaseObject* M_StdBoolObject::__str__(mtpython::vm::ThreadContext* context,
                                       mtpython::objects::M_BaseObject* self)
{
    M_StdBoolObject* as_bool = M_STDBOOLOBJECT(self);
    assert(as_bool);
...
{
    static mtpython::interpreter::Typedef bool_typedef(
        "bool",
        {
            {"__bool__",
             new InterpFunctionWrapper("__bool__", M_StdBoolObject::__bool__)},
            {"__repr__",
             new InterpFunctionWrapper("__repr__", M_StdBoolObject::__repr__)},
            {"__str__",
             new InterpFunctionWrapper("__str__", M_StdBoolObject::__str__)},
            {"__and__",
             new InterpFunctionWrapper("__and__", M_StdBoolObject::__and__)},
        });
...
M_BaseObject* M_StdBoolObject::__bool__(mtpython::vm::ThreadContext* context,
                                        M_BaseObject* self)
{
    return self;
}

M_BaseObject* M_StdBoolObject::__and__(mtpython::vm::ThreadContext* context,
