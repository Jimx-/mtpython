...
{
    static Typedef Module_typedef(
        "module", {
                      {"__repr__",
                       new InterpFunctionWrapper("__repr__", Module::__repr__)},
...
M_BaseObject* Module::call(mtpython::vm::ThreadContext* context,
...
M_BaseObject* Module::__repr__(mtpython::vm::ThreadContext* context,
                               M_BaseObject* self)
{
...
M_BaseObject* Module::__dict__get(mtpython::vm::ThreadContext* context,
                                  M_BaseObject* self)
{
