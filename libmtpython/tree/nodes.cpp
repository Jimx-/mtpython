...
NODE_CONSTRUCTOR(ModuleNode) { body = nullptr; }

NODE_CONSTRUCTOR(FunctionDefNode) { body = nullptr; }

NODE_CONSTRUCTOR(NameNode) { ctx = EC_LOAD; }
...
NODE_CONSTRUCTOR(DeleteNode) { targets.clear(); }

NODE_CONSTRUCTOR(YieldNode) { value = nullptr; }

NODE_CONSTRUCTOR(YieldFromNode) { value = nullptr; }
...
NODE_CONSTRUCTOR(NumberNode) { value = nullptr; }

NODE_CONSTRUCTOR(StringNode) { value = nullptr; }

NODE_CONSTRUCTOR(CallNode) { func = nullptr; }

NODE_CONSTRUCTOR(KeywordNode) { value = nullptr; }

NODE_CONSTRUCTOR(ExprNode) { value = nullptr; }

NODE_CONSTRUCTOR(ConstNode) { value = nullptr; }
...
NODE_CONSTRUCTOR(AttributeNode) { value = nullptr; }
...
NODE_CONSTRUCTOR(GeneratorExpNode) { elt = nullptr; }
...
NODE_CONSTRUCTOR(IndexNode) { value = nullptr; }
...
NODE_CONSTRUCTOR(WithNode) { body = nullptr; }
...
NODE_CONSTRUCTOR(ClassDefNode) { body = nullptr; }
